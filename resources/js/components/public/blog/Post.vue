          ...
          <div class="span8">
                ...
                <div class="span8">
                  <div class="post-image">
                    <div class="post-heading">
                      <h3>
                        <a href="#">{{ singlepost.title }} {{ this.$route.params.id }}</a>
                      </h3>
                    </div>
                    <img :src="`./../assets/admin/posts/${singlepost.photo}`" alt>
                  </div>
                  ...
                  <div class="bottom-article">
                    <ul class="meta-post">
                      ...
                      <li v-if="singlepost.category">
                        ...
                        <a href="#">{{ singlepost.category.name }}</a>
                      </li>
                      <li>
                        <i class="icon-tags"></i>
                        <a href="#">Web design</a>
            ...
            <div class="about-author">
              <a href="#" class="thumbnail align-left">
                <img :src="`./../fontend/img/avatar.png`" alt>
              </a>
              <h5>
                <strong>
                  <a href="#">John doe</a>
              ...
              <p>Qui ut ceteros comprehensam. Cu eos sale sanctus eligendi, id ius elitr saperet, ocurreret pertinacia pri an. No mei nibh consectetuer, semper ad qui, est rebum nulla argumentum ei.</p>
            </div>
            <div class="comment-area">
              ...
              <div class="media">
                ...
                <div class="media-body">
                  <div class="media-content">
                    <h6>
                      <span>March 12, 2013</span> Karen medisson
                    </h6>
              ...
              <div class="media">
                ...
                <div class="media-body">
                  <div class="media-content">
                    <h6>
                      <span>March 12, 2013</span> Smith sanderson
                    </h6>
                    <p>Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin commodo. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.</p>
                    <a href="#" class="align-right">Reply comment</a>
                  </div>
                  <div class="media">
                    ...
                    <div class="media-body">
                      <div class="media-content">
                        <h6>
                          <span>March 12, 2013</span> Thomas guttenberg
                        </h6>
                        <p>Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin commodo. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.</p>
                        <a href="#" class="align-right">Reply comment</a>
                      </div>
              ...
              <div class="media">
                ...
                <div class="media-body">
                  <div class="media-content">
                    <h6>
                      <span>March 12, 2013</span> Vicky lumora
                    </h6>
                    <p>Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin commodo. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.</p>
                    <a href="#" class="align-right">Reply comment</a>
                  </div>
...
export default {
  ...
  watch: {
    $route(to, from) {
      // watch change when use click post deferent
      this.singlePost();
    }
  }
};
